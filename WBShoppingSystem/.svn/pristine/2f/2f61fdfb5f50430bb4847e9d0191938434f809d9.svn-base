		...
		<div class="dl-con">
			<div class="forgot_password">
				<div class="forgot_password_t">
					<p>忘记了密码？ 请输入用户名和注册时填写的邮箱， 我们会把重新设置的密码邮件发送到您的邮箱 ！</p>
				</div><!--forgot_password_t end-->
				<div class="blank10"></div>
				<div class="forgot_password_m" id="regist">
				<form id="formpersonal" method="post" onsubmit="return false;" class="form">
					...
					<div class="item">
						...
						<div class="fl">
							...
							<label><a  class="blue"></a>获取验证码</label>
						</div>
					</div><!--item end-->
					<div class="item">
						<span class="label">&nbsp;</span>
						<input type="button" class="yellow_button yellow_button_03" id="registsubmit"  value="提&nbsp;&nbsp;交" tabindex="4" />
					</div><!--item end-->
				</form>	
