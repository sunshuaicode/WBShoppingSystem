					...
					<div class="side_list">
						...
						<div class="widget-body">
							<ul class="b_P_Sort_list">
								...
								<li><i class="fa fa-shopping-bag pink "></i> <a href="#">保健品类(3)</a>
								</li>
			...
			<div class="Ads_list">
				<div class="search_style">
					...
					<ul class="search_content clearfix">
						<li><label class="l_f">报表类型</label><select name=""
							style="width: 150px"><option>--选择报表类型--</option></select></li>
						<li><label class="l_f">信息来源</label><input name="" type="text"
							class="text_add" placeholder="信息来源" style="width: 150px"></li>
						<li><label class="l_f">咨询方式</label><input name="" type="text"
							class="text_add" placeholder="咨询方式" style="width: 150px"></li>
						<li><label class="l_f">校区</label><input name="" type="text"
							class="text_add" placeholder="校区" style="width: 200px"></li>
				...
				<div class="border clearfix">
					<span class="l_f"><a href="javascript:ovid()"
						class="btn btn-danger"><i class="fa fa-trash"></i> 批量删除</a></span> <span
						class="r_f">共：<b>45</b>家
					</span>
				</div>
						...
						<tbody>
							<tr>
								...
								<td class="td-manage"><a title="删除" href="javascript:;"
									onclick="member_del(this,'1')" class="btn btn-xs btn-danger"><i
							...
							<tr>
								...
								<td>保健食品</td>
								<td>个人店铺</td>
								<td class="displayPart" displayLength="60">付款方式分为以下几种：（注：先款订单请您在订单提交后24小时内完成支付，
									否则订单会自动取消）</td>
								<td>2016-7-25 12:34</td>
								<td>通过</td>
