...
<div class="content container">
	<div class="breadcrumbs">
		<a href="index.jsp">首页</a><span>></span><a href="#">我的麦路客</a><span>></span>电子优惠券
	</div><!--breadcrumbs end-->
		...
		<div class="personal_l_m" id="personal_list">
			<dl>
				...
				<dd>
					...
					<a href="e-coupons.jsp" class="current">电子优惠券</a>
				</dd>
			</dl>
			<dl>
	...
	<div class="f_r personal_r">
		...
		<div class="personal_r_m">
			...
			<div class="personal_r_m_m">
				...
				<div class="coll_m">
					<div class="coll_m_t"><h3>未使用优惠券</h3></div>
					<table width="100%">
						<thead>
							<tr>
								<th>编号</th><th>面值</th><th>消费金额</th><th>有效时间</th><th>使用</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td colspan="5">您没有可使用的电子优惠券</td>
							</tr>
							<tr>
								<td><a href="#" class="blue">2010091947156</a></td>
								<td><span class="red">￥6.00元</span></td>
								<td><span>￥95.25元</span></td>
								<td><span>2010-09-19 — 2011-09-19</span></td>
								<td><a href="#" class="yellow">立即抵消</a></td>
							</tr>
							<tr bgcolor="#f7f7f7">
								<td><a href="#" class="blue">2010091947156</a></td>
								<td><span class="red">￥6.00元</span></td>
				...
				<div class="coll_m">
					<div class="coll_m_t"><h3>已使用优惠券</h3></div>
					<table width="100%">
						<thead>
							<tr>
								<th>编号</th><th>面值</th><th>消费金额</th><th>订单</th><th>使用时间</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td colspan="5">您还未使用的电子优惠券</td>
							</tr>
							<tr>
								<td><a href="#" class="blue">2010091947156</a></td>
								<td><span class="red">￥6.00元</span></td>
								<td><span>￥95.25元</span></td>
								<td><span>2010091947156<br />2010091947156</span></td>
								<td><span>2011-09-19</span></td>
							</tr>
							<tr bgcolor="#f7f7f7">
								<td><a href="#" class="blue">2010091947156</a></td>
								<td><span class="red">￥6.00元</span></td>
			...
			<div class="yh_quan">
				<h5>提示：</h5>
				<p>1、电子优惠券是有买特定销售商品得到的。<br />2、您的电子优惠券，有效期为一年，自成功兑换之日起计算。<br />3、电子优惠券仅限本ID使用，不能折算为现金、也不能兑换为积分。 </p>
			</div><!--yh_quan end-->
