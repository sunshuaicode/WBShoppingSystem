...
<body>
	<div class="margin clearfix">
		<div class="border clearfix">
			<span class="l_f"> <a href="${pageContext.request.contextPath}/view_admin/Competence.jsp"
...
function Competence_modify(id){
		window.location.href ="${pageContext.request.contextPath}/view_admin/Competence.jsp?="+id;
};	
/*字数限制*/
