...
<!-- <![endif]-->
<!--[if IE]>
         <script type="text/javascript">window.jQuery || document.write("<script src='${pageContext.request.contextPath}/view_admin/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='${pageContext.request.contextPath}/view_admin/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
...
<!--[if lte IE 8]>
		  <script src="${pageContext.request.contextPath}/view_admin/assets/js/excanvas.min.js"></script>
		<![endif]-->
<script src="${pageContext.request.contextPath}/view_admin/assets/js/ace-elements.min.js"></script>
<script src="${pageContext.request.contextPath}/view_admin/assets/js/ace.min.js"></script>
...
<script src="${pageContext.request.contextPath}/view_admin/js/jquery.nicescroll.js" type="text/javascript"></script>
<script type="text/javascript">
...
$('.change_Password').on('click', function(){
  ...
  $('#Exit_system').on('click', function(){
	...
	function(){
	  location.href="${pageContext.request.contextPath}/view_admin/view/login.jsp";
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand"> <small> <img
						src="${pageContext.request.contextPath}/view_admin/images/logo.png" width="470px">
				</small>
				</a>
				<!-- /.brand -->
			</div>
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <span class="time"><em
								id="time"></em></span><span class="user-info"><small>欢迎光临,</small><%=username %></span>
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						<li class="home"><a href="javascript:void(0)"
							name="${pageContext.request.contextPath}/view_admin/view/home.jsp" class="iframeurl" title=""><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Products_List.jsp" title="产品类表" class="iframeurl"><i
										class="icon-double-angle-right"></i>产品类表</a></li>
								<%-- <li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Brand_Manage.jsp" title="品牌管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>品牌管理</a></li> --%>
								<%-- <li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Category_Manage.jsp" title="分类管理" class="iframeurl"><i
						...
						<%-- <li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/advertising.jsp" title="广告管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>广告管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Sort_ads.jsp" title="分类管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>分类管理</a></li>
							</ul></li> --%>
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/transaction.jsp" title="交易信息" class="iframeurl"><i
										class="icon-double-angle-right"></i>交易信息</a></li>					
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Orderform.jsp" title="订单管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>订单管理</a></li>
								<%-- <li class="home"><div onClick="$.windowbox.aa()"><a href="javascript:void(0)" 
									name="${pageContext.request.contextPath}/view_admin/view/Amounts.jsp" title="交易金额" class="iframeurl"><i
										class="icon-double-angle-right"></i>交易金额</a></div></li> --%>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Order_handling.jsp" title="订单处理" class="iframeurl"><i
										class="icon-double-angle-right"></i>订单处理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Refund.jsp" title="退款管理" class="iframeurl"><i
						...
						<%-- <li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Cover_management.jsp" title="账户管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>账户管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/payment_method.jsp" title="支付方式" class="iframeurl"><i
										class="icon-double-angle-right"></i>支付方式</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Payment_Configure.jsp" title="支付配置" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/user_list.jsp" title="会员列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>会员列表</a></li>
								<%-- <li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/member-Grading.jsp" title="等级管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>等级管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/integration.jsp" title="会员记录管理" class="iframeurl"><i
						...
						<%-- <li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Shop_list.jsp" title="店铺列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>店铺列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Shops_Audit.jsp" title="店铺审核" class="iframeurl"><i
						...
						<%-- <li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Guestbook.jsp" title="留言列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>留言列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Feedback.jsp" title="意见反馈" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/article_list.jsp" title="文章列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>文章列表</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/article_Sort.jsp" title="分类管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>分类管理</a></li>
							</ul></li>
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/Systems.jsp" title="系统设置" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统设置</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/System_section.jsp" title="系统栏目管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>系统栏目管理</a></li>

								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/System_Logs.jsp" title="系统日志" class="iframeurl"><i
						...
						<li><a href="#" class="dropdown-toggle"><i
							...
							<ul class="submenu">
								...
								<%-- <li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/admin_Competence.jsp" title="权限管理" class="iframeurl"><i
										class="icon-double-angle-right"></i>权限管理</a></li>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/administrator.jsp" title="管理员列表" class="iframeurl"><i
										class="icon-double-angle-right"></i>管理员列表</a></li> --%>
								<li class="home"><a href="javascript:void(0)"
									name="${pageContext.request.contextPath}/view_admin/view/admin_info.jsp" title="个人信息" class="iframeurl"><i
           ...
           $("#menu_style").niceScroll({  
			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						<li><i class="icon-home home-icon"></i> <a href="${pageContext.request.contextPath}/view_admin/view/index.jsp">首页</a>
						</li>
				...
				<iframe id="iframe"
					...
					name="iframe" frameborder="0" src="${pageContext.request.contextPath}/view_admin/view/home.jsp"> </iframe>
...
<!-- 	<div class="footer_style" id="footerstyle">
		...
		<p class="r_f">
			地址：南京市鼓楼区阅江楼街道公共路64号 邮编：210011 素材牛 - <a
				href="http://www.sucainiu.com/templates" target="_blank">免费模板下载</a>
		</p>
	</div> -->
	<!--修改密码样式-->
