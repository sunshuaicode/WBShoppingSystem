...
<link href="${pageContext.request.contextPath}/view_admin/assets/css/codemirror.css" rel="stylesheet">
	...
	<link rel="stylesheet"
		href="${pageContext.request.contextPath}/view_admin/Widget/zTree/css/zTreeStyle/zTreeStyle.css" type="text/css">
       ...
       <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='${pageContext.request.contextPath}/view_admin/assets/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
		</script>
		<!-- <![endif]-->
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='${pageContext.request.contextPath}/view_admin/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/view_admin/Widget/zTree/js/jquery.ztree.all-3.5.min.js"></script>
	...
	<div class=" clearfix">
		<div id="category">
			...
			<iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0
				SCROLLING=AUTO SRC="${pageContext.request.contextPath}/view_admin/view/product-category-add.jsp"
