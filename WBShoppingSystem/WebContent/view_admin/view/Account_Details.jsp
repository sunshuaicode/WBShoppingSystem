...
<meta name="renderer" content="webkit|ie-comp|ie-stand">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		...
		<![endif]-->
			...
			<script src="vjs/jquery.SuperSlide.2.1.1.js"></script>
			...
			<script src="vassets/layer/layer.js" type="text/javascript"></script>
		...
		<div class="Account_style">
			...
			<div class="Manager_style clearfix">
				...
				<ul class="Account_info">
					<li><label class="label_name">账户名（用户名）：</label><span
						class="content">化海天堂</span></li>
					<li><label class="label_name">用户注册时间：</label><span
						class="content">2016-3-12</span></li>
					<li><label class="label_name">账户开通时间：</label><span
						class="content">2016-4-12</span></li>
					<li><label class="label_name">账户状态：</label><span
						class="content">启用</span></li>
				</ul>
