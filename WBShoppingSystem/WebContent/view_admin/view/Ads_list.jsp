...
<meta name="renderer" content="webkit|ie-comp|ie-stand">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		...
		<link href="${pageContext.request.contextPath}/view_admin/assets/css/codemirror.css" rel="stylesheet">
			<link rel="stylesheet" href="${pageContext.request.contextPath}/view_admin/assets/css/colorbox.css">
				<!--图片相册-->
		...
		<![endif]-->
				...
				<script src="${pageContext.request.contextPath}/view_admin/assets/js/jquery.colorbox-min.js"></script>
				...
				<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/swfupload/swfupload.js"></script>
				<script type="text/javascript"
					src="${pageContext.request.contextPath}/view_admin/Widget/swfupload/swfupload.queue.js"></script>
				<script type="text/javascript"
					src="${pageContext.request.contextPath}/view_admin/Widget/swfupload/swfupload.speed.js"></script>
				<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/swfupload/handlers.js"></script>
					...
					<tbody>
						<tr>
							...
							<td><input name="" type="text" style="width: 50px"
								placeholder="1" /></td>
							<td><span class="ad_img"><a href="${pageContext.request.contextPath}/view_admin/products/ad.jpg"
									data-rel="colorbox" data-title="广告图"><img
										src="${pageContext.request.contextPath}/view_admin/products/ad.jpg" width="100%" height="100%" /></a></span></td>
							<td>1890x1080</td>
						...
						<tr>
							...
							<td><input name="" type="text" style="width: 50px"
								placeholder="2" /></td>
							<td><span class="ad_img"><a href="${pageContext.request.contextPath}/view_admin/products/p_42.jpg"
									data-rel="colorbox" data-title="广告图"><img
										src="${pageContext.request.contextPath}/view_admin/products/p_42.jpg" width="100%" height="100%" /></a></span></td>
							<td>1890x1080</td>
							<td><a href="#" target="_blank">http://item.jd.com/10443270082.html</a></td>
							<td>2016-6-29 12:34</td>
							<td class="td-status"><span
				...
				<li><label class="label_name">图片</label><span
					class="cont_style">
						<div class="demo">
							<div class="logobox">
								<div class="resizebox">
									<img src="${pageContext.request.contextPath}/view_admin/images/image.png" width="100px" alt="" height="100px" />
								</div>
							</div>
...
$(document).ready(function() {
	var settings = {
		flash_url : "${pageContext.request.contextPath}/view_admin/Widget/swfupload/swfupload.swf",
		flash9_url : "${pageContext.request.contextPath}/view_admin/Widget/swfupload/swfupload_fp9.swf",
		upload_url: "${pageContext.request.contextPath}/view_admin/upload.php",// 接受上传的地址
		...
		debug: false,
		// Button settings
		button_image_url: "${pageContext.request.contextPath}/view_admin/Widget/swfupload/upload-btn.png",
		button_width: "95",
		button_height: "30 ",
