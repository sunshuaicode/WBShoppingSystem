		...
		<div class="cover_style" id="cover_style">
			<div class="search_style">
				...
				<ul class="search_content clearfix">
					<li><label class="l_f">用户</label><input name="" type="text"
						class="text_add" placeholder="用户名称" style="width: 250px"></li>
			...
			<div class="border clearfix">
				<span class="l_f"> <a href="javascript:ovid()"
					class="btn btn-danger"><i class="fa fa-bar-chart"></i>&nbsp;图表展示</a>
				</span> <span class="r_f">共：<b>2334</b>个账户
				</span>
			</div>
			<!--账户管理-->
			<div class="">
				<table class="table table-striped table-bordered table-hover"
					...
					<thead>
						<tr>
							<th width=""><label><input type="checkbox"
					...
					<tbody>
						<tr>
							...
							<td><u style="cursor: pointer" class="text-primary"
								onclick="member_show('张小泉','member-show.html','1031','500','400')">张奶奶</u></td>
							<td>345.2</td>
							<td>0.00</td>
							<td>无</td>
							<td>购买商品消费122元</td>
							...
							<td class="td-manage"><a onClick="member_stop(this,'10001')"
								href="javascript:;" title="启用" class="btn btn-xs btn-success"><i
									class="fa fa-check  bigger-120"></i></a> <a
								href="javascript:ovid()" name="Account_Details.html"
								class="btn btn-xs  btn-warning Account_Details"
								onclick="generateOrders('511');" title="张奶奶账户详细"> <i
									class="fa fa-list-ul bigger-120"></i></a></td>
						</tr>
						<tr>
							<td><label><input type="checkbox" class="ace"><span
										class="lbl"></span></label></td>
							...
							<td class="td-manage"><a onClick="member_stop(this,'10001')"
								...
								href="javascript:ovid()" name="Account_Details.html"
								class="btn btn-xs  btn-warning Account_Details"
								onclick="generateOrders('561');" title="张小泉账户详细"> <i
									class="fa fa-list-ul bigger-120"></i></a></td>
						</tr>
					</tbody>
				</table>
