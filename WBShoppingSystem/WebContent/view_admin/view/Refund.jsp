		...
		<div id="refund_style">
			...
			<div class="border clearfix">
				<span class="l_f"> <a href="javascript:ovid()"
					...
					href="javascript:ovid()" class="btn btn-warning Order_form"><i
						class="fa fa-close"></i>&nbsp;未退款订单</a> <a href="javascript:ovid()"
					class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;批量删除</a>
				</span> <span class="r_f">共：<b>2334</b>笔
				</span>
			</div>
			<!--退款列表-->
					...
					<tbody>
						<tr>
							...
							<td class="td-status"><span
								class="label label-success radius">待退款</span></td>
							<td>重复购买商品需退款一件</td>
							<td><a onClick="Delivery_Refund(this,'10001')"
								href="javascript:;" title="退款" class="btn btn-xs btn-success">退款</a>
								<a title="退款订单详细" href="${pageContext.request.contextPath}/view_admin/Refund_detailed.jsp"
								class="btn btn-xs btn-info Refund_detailed">详细</a> <a
								title="删除" href="javascript:;"
								onclick="Order_form_del(this,'1')"
						...
						<tr>
							...
							<td>1</td>
							<td class="td-status"><span
								class="label label-defaunt radius">已退款</span></td>
							<td>重复购买商品需退款一件</td>
							<td><a title="退款订单详细" href="${pageContext.request.contextPath}/view_admin/Refund_detailed.jsp"
								class="btn btn-xs btn-info Refund_detailed">详细</a> <a
								title="删除" href="javascript:;"
								onclick="Order_form_del(this,'1')"
								class="btn btn-xs btn-warning">删除</a></td>
