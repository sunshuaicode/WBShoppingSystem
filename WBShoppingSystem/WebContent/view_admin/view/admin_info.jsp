			...
			<div class="admin_modify_style" id="Personal">
				...
				<div class="xinxi">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="用户名" id="website-title" value="admin"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="电子邮箱" id="website-title"
								value="595929455@qq.com" class="col-xs-7 text_info"
								disabled="disabled">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="QQ" id="website-title" value="595929455"
								class="col-xs-7 text_info" disabled="disabled">
						</div>
					</div>
					<div class="form-group">
