...
<meta name="renderer" content="webkit|ie-comp|ie-stand">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		...
		<![endif]-->
			...
			<script src="${pageContext.request.contextPath}/view_admin/js/displayPart.js" type="text/javascript"></script>
		...
		<div class="article_style" id="article_style">
					...
					<div class="side_list">
						...
						<div class="widget-body">
							<ul class="b_P_Sort_list">
								...
								<li><i class="fa fa-newspaper-o pink "></i> <a href="#">常见问题(3)</a>
								</li>
			...
			<div class="Ads_list">
				<div class="border clearfix">
					<span class="l_f"> <a href="${pageContext.request.contextPath}/view_admin/article_add.jsp" title="添加文章"
						id="add_page" class="btn btn-warning"><i class="fa fa-plus"></i>
							添加文章</a> <a href="javascript:ovid()" class="btn btn-danger"><i
							class="fa fa-trash"></i> 批量删除</a>
					</span> <span class="r_f">共：<b>45</b>条文章
					</span>
				</div>
						...
						<tbody>
							<tr>
								...
								<td class="td-manage"><a title="编辑"
									onclick="member_edit('编辑','${pageContext.request.contextPath}/view_admin/member-add.jsp','4','','510')"
