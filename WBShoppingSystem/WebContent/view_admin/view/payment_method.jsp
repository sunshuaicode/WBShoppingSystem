		...
		<div class="defray_style">
			...
			<div class="border clearfix">
				<span class="l_f"> <a href="javascript:ovid()"
					onclick="add_payment()" class="btn btn-primary Pay_add"><i
			...
			<div class="defray_list cover_style clearfix">
				...
				<div class="defray_content clearfix">
					<ul class="defray_info">
						...
						<li class="name_logo"><img src="products/black/zhifb.jpg"
							width="100%" height="150px;" /></li>
						...
						<li class="operating"><a href="javascript:ovid()"
							class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a> <a
							href="javascript:ovid()" class="btn btn-success"><i
								class="fa  fa-edit "></i>&nbsp;设置</a></li>
					</ul>
					<ul class="defray_info">
						<li class="defray_name">微信支付</li>
						<li class="name_logo"><img src="products/black/weixin.jpg"
							width="100%" height="150px;" /></li>
						...
						<li class="select"><label><input
							...
							<label><input name="form-field-radio1" type="radio"
								class="ace"><span class="lbl">关闭</span></label></li>
						<li class="operating"><a href="javascript:ovid()"
							class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a> <!-- <a href="javascript:ovid()" class="btn btn-success details_btn"><i class="fa  fa-newspaper-o "></i>&nbsp;详细</a>-->
						</li>
					</ul>
					<ul class="defray_info">
						<li class="defray_name">银联</li>
						<li class="name_logo"><img src="products/black/yinglian.jpg"
							width="100%" height="150px;" /></li>
						...
						<li class="operating"><a href="javascript:ovid()"
							class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a> <a
							href="javascript:ovid()" name="Payment_details.html"
							title="银联支付详细" onclick="Paymentdetails('134')"
							class="btn btn-success details_btn"><i
								class="fa  fa-newspaper-o "></i>&nbsp;详细</a></li>
					</ul>
					<ul class="defray_info">
						<li class="defray_name">怡宝支付</li>
						<li class="name_logo"><img src="products/black/yozhif.jpg"
							width="100%" height="150px;" /></li>
						<li class="description">中国银联是中国银行卡联合组织，通过银联跨行交易清算系统，实现商业银行系统间的互联互通和资源共享，保证银行卡跨行、跨地区和跨境的使用。</li>
						<li class="select"><label><input
							...
							<label><input name="form-field-radio3" type="radio"
								class="ace"><span class="lbl">关闭</span></label></li>
						<li class="operating"><a href="javascript:ovid()"
							class="btn btn-danger"><i class="fa fa-trash"></i>&nbsp;删除</a> <!-- <a href="javascript:ovid()" name="Payment_details.html" title="怡宝支付详细" onclick="Paymentdetails('234')" class="btn btn-success details_btn"><i class="fa  fa-newspaper-o "></i>&nbsp;详细</a>-->
						</li>
					</ul>
				</div>
			</div>
