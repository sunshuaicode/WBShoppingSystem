...
<link href="${pageContext.request.contextPath}/view_admin/Widget/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
...
<!-- <div id="scrollsidebar" class="left_Treeview">
 ...
 <div class="type_title "><h1>添加商品:</h1></div>
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red"></span>商品编号：</label>
		 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name=""></div>
		</div>
		<div class=" clearfix cl">
         <label class="form-label col-4">商品名称：</label>
	     <div class="formControls col-4"><input type="text" class="input-text" value="" placeholder="" id="" name=""></div>
		</div>
		<div class=" clearfix cl">
		...
		<div class="Add_p_s">
             ...
             <div class="Add_p_s">
             <label class="form-label col-2">商品供货商：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="" ></div>
			</div>
		...
		<div class="page_right_style" position="relative"; left="40px"; top="10px">
			...
			<form action="" method="post" class="form form-horizontal" id="form-article-add">
				...
				<div class=" clearfix cl">
						<label class="form-label col-10">产品信息：</label>
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder=""
								id="" name="">
				...
				<div class=" clearfix cl">
						<label class="form-label col-2">产品供应商：</label>
						<div class="formControls col-2">
							<input type="text" class="input-text" value="" placeholder=""
								id="" name="">
						</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/My97DatePicker/WdatePicker.js"></script> 
<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/icheck/jquery.icheck.min.js"></script> 
...
<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/Validform/5.3.2/Validform.min.js"></script> 
<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="${pageContext.request.contextPath}/view_admin/Widget/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script> 
