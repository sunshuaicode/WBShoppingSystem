	...
	<div class="site-nav">
		<div class="floor_nav">
			<ul class="floors">
				...
				<li id="floor_5"><a href="bags.jsp" class="selected track">箱包</a></li>
...
<div class="content container">
	<div class="breadcrumbs"><a href="index.jsp">首页</a><span>></span>箱包</div><!--breadcrumbs end-->
	<div class="area_l con_l">
		<div class="product-sort">
			<h2>商品分类</h2>
			<div class="sort-con">
				<div class="sort-list">
					<h3><span class="f_l icon05"></span><a href="bags.jsp" class="f_l">箱包</a></h3>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="#" class="f_l">配件</a></dt>
						<dd>
							<a href="#"><span>·</span>太阳镜 (<b class="yellow">9</b>)</a>
							<a href="#"><span>·</span>丝巾 (<b class="yellow">7</b>)</a>
							<a href="#"><span>·</span>披肩 (<b class="yellow">6</b>)</a>
							<a href="#"><span>·</span>帽子 (<b class="yellow">5</b>)</a>
							<a href="#"><span>·</span>手套 (<b class="yellow">2</b>)</a>
							<a href="#"><span>·</span>皮带 (<b class="yellow">10</b>)</a>
						</dd>
					</dl>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="#" class="f_l">饰品</a></dt>
						<dd>
							<a href="#"><span>·</span>手表 (<b class="yellow">9</b>)</a>
							<a href="#"><span>·</span>耳环 (<b class="yellow">3</b>)</a>
							<a href="#"><span>·</span>戒指 (<b class="yellow">6</b>)</a>
							<a href="#"><span>·</span>吊坠 (<b class="yellow">10</b>)</a>
							<a href="#"><span>·</span>项链 (<b class="yellow">9</b>)</a>
							<a href="#"><span>·</span>手链 (<b class="yellow">3</b>)</a>
							<a href="#"><span>·</span>手镯 (<b class="yellow">6</b>)</a>
							<a href="#"><span>·</span>发饰 (<b class="yellow">3</b>)</a>
							<a href="#"><span>·</span>钥匙扣 (<b class="yellow">8</b>)</a>
							<a href="#"><span>·</span>手机链 (<b class="yellow">2</b>)</a>
						</dd>
					</dl>
				</div>
	...
	<div class="area_r con_r">
		...
		<div class="category">
			...
			<div class="StyleListProduct">
				<ul class="clearfix">
					<li>
						<a class="p_photo" title="优雅镂空条纹针织衫" href="product-details.jsp"><img alt="优雅镂空条纹针织衫" src="images/spacer.gif" lazyload="images/women/product/0000946.jpg" width="150" height="205" class="load_img pic" /></a>						
						<div class="p_name"><a href="product-details.jsp">雅镂空条纹针织衫</a></div>
						<div class="p_price"><del title="市场价">¥80.00元</del><strong title="麦路客价">¥50.00元</strong></div>
						<div class="p_safe"><span class="blue">满意度：5.0分</span><span class="icon jifen" title="送积分"></span></div>
						<div class="p_button"><a href="cart.jsp">购买</a><a href="my-favorites.jsp">收藏</a></div>
						<div class="preview"><p class="pic">images/mid.jpg</p></div>
					</li>	
					<li>
						<a class="p_photo" title="优雅镂空条纹针织衫" href="product-details.jsp"><img alt="经典高领长袖打底衫" src="images/spacer.gif" lazyload="images/women/product/0000665.jpg" width="150" height="205" class="load_img pic" /></a>							
						<div class="p_name"><a href="product-details.jsp">雅镂空条纹针织衫</a></div>
						<div class="p_price"><del title="市场价">¥80.00元</del><strong title="麦路客价">¥50.00元</strong></div>
					...
					<li>
						<a class="p_photo" title="优雅镂空条纹针织衫" href="product-details.jsp"><img alt="性感高弹网袜 黑色" src="images/spacer.gif" lazyload="images/women/product/0001355.jpg" width="150" height="205" class="load_img pic" /></a>						
						<div class="p_name"><a href="product-details.jsp">雅镂空条纹针织衫</a></div>
						<div class="p_price"><del title="市场价">¥80.00元</del><strong title="麦路客价">¥50.00元</strong></div>
						<div class="p_safe"><span class="blue">满意度：5.0分</span><span class="icon quan" title="电子优惠券"></span></div>
						<div class="p_button"><a href="cart.jsp">购买</a><a href="my-favorites.jsp">收藏</a></div>
						<div class="preview"><p class="pic">images/mid.jpg</p></div>
					</li>	
					<li>
						<a class="p_photo" title="优雅镂空条纹针织衫" href="product-details.jsp"><img alt="百搭果色天鹅绒九分连裤袜" src="images/spacer.gif" lazyload="images/women/product/0000946.jpg" width="150" height="205" class="load_img pic" /></a>							
						<div class="p_name"><a href="product-details.jsp">雅镂空条纹针织衫</a></div>
						<div class="p_price"><del title="市场价">¥80.00元</del><strong title="麦路客价">¥50.00元</strong></div>
						<div class="p_safe"><span class="blue">满意度：5.0分</span><span class="icon zhijiang" title="直降"></span></div>
						<div class="p_button"><a href="cart.jsp">购买</a><a href="my-favorites.jsp">收藏</a></div>
						<div class="preview"><p class="pic">images/mid.jpg</p></div>
					</li>	
					<li>
						<a class="p_photo" title="优雅镂空条纹针织衫" href="product-details.jsp"><img alt="优雅镂空条纹针织衫" src="images/spacer.gif" lazyload="images/women/product/0001887.jpg" width="150" height="205" class="load_img pic" /></a>							
						<div class="p_name"><a href="product-details.jsp">雅镂空条纹针织衫</a></div>
						<div class="p_price"><del title="市场价">¥80.00元</del><strong title="麦路客价">¥50.00元</strong></div>
						<div class="p_safe"><span class="blue">满意度：5.0分</span><span class="icon quan" title="电子优惠券"></span></div>
						<div class="p_button"><a href="cart.jsp">购买</a><a href="my-favorites.jsp">收藏</a></div>
