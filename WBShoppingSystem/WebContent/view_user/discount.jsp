...
<div class="content container">
	<div class="breadcrumbs">
		<a href="index.jsp">首页</a><span>></span>折扣积分
	</div><!--breadcrumbs end-->
	<div class="discount">
		<ul class="discount-btn">
			<li><a class="current" name="a1"><b>5</b>折区</a></li>
			<li><a href="#a2"><b>6</b>折区</a></li>
			<li><a href="#a3"><b>7</b>折区</a></li>
			<li><a href="#a4"><b>8</b>折区</a></li>
			<li><a href="#a5"><b>9</b>折区</a></li>
			<li class="last">您的当前积分：<b class="red">4000</b>&nbsp;积分</li>
		</ul><!--discount-btn end-->
		<div class="discount-con modpic bigTarget clearfix">
			<ul>
				<li>
					<a href="product-details.jsp"><img class="load_img" src="images/spacer.gif" lazyload="images/women/0000448.jpg" width="150" height="205" alt="美腿配丝袜" /></a>
					<div class="p-name"><a rel="nofollow external" href="product-details.jsp">美腿配丝袜</a></div>
					<div class="p-price">麦路客价：<strong>&yen;50.00</strong></div>
					<div class="exchange">
						全额兑换：<strong class="coin">13460</strong>积分<br /><strong class="coin">￥30.00</strong>+&nbsp;<strong class="coin">4320</strong>积分
					</div>
				</li>
				<li>
					<a href="product-details.jsp"><img class="load_img" src="images/spacer.gif" lazyload="images/women/0000448.jpg" width="150" height="205" alt="美腿配丝袜" /></a>
		...
		</div><!--discount-con end-->
	</div><!--discount end-->
	<div class="discount">
		<ul class="discount-btn">
			<li><a href="#a1"><b>5</b>折区</a></li>
			<li><a class="current" name="a2"><b>6</b>折区</a></li>
			<li><a href="#a3"><b>7</b>折区</a></li>
			<li><a href="#a4"><b>8</b>折区</a></li>
			<li><a href="#a5"><b>9</b>折区</a></li>
			<li class="last">您的当前积分：<b class="red">4000</b>&nbsp;积分</li>
	...
	<div class="discount">
		<ul class="discount-btn">
			<li><a href="#a1"><b>5</b>折区</a></li>
			<li><a href="#a2"><b>6</b>折区</a></li>
			<li><a class="current" name="a3"><b>7</b>折区</a></li>
			<li><a href="#a4"><b>8</b>折区</a></li>
			<li><a href="#a5"><b>9</b>折区</a></li>
			<li class="last">您的当前积分：<b class="red">4000</b>&nbsp;积分</li>
		</ul><!--discount-btn end-->
	...
	<div class="discount">
		<ul class="discount-btn">
			...
			<li><a href="#a2"><b>6</b>折区</a></li>
			<li><a href="#a3"><b>7</b>折区</a></li>
			<li><a class="current" name="a4"><b>8</b>折区</a></li>
			<li><a href="#a5"><b>9</b>折区</a></li>
			<li class="last">您的当前积分：<b class="red">4000</b>&nbsp;积分</li>
		</ul><!--discount-btn end-->
		<div class="discount-con modpic bigTarget clearfix">
	...
	<div class="discount">
		<ul class="discount-btn">
			...
			<li><a href="#a3"><b>7</b>折区</a></li>
			<li><a href="#a4"><b>8</b>折区</a></li>
			<li><a class="current" name="a5"><b>9</b>折区</a></li>
			<li class="last">您的当前积分：<b class="red">4000</b>&nbsp;积分</li>
		</ul><!--discount-btn end-->
		<div class="discount-con modpic bigTarget clearfix">
			<ul>
...
<script type="text/javascript">$(function(){ $(".bigTarget li .p-name a").bigTarget( ); });</script>
<!-- online -->
