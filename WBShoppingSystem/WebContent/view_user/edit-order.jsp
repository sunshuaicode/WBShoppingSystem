...
<div class="o_h container">
	<h1 class="f_l oh_logo"><a href="#"><img src="images/logo.gif" alt="麦路客网上购物商城" /></a></h1><!--oh_logo end-->
	<div class="f_r oh_mian">
		<div class="oh_dh">
			<div class="f_r l_bg"></div>
			<div class="f_r oh_dh_m">请<a href="#" class="red">登录</a>或<a href="#" class="red">注册</a><span>|</span><a href="#">麦路客首页</a><span>|</span><a href="#">我的麦路客</a><span>|</span><a href="#">帮助中心</a></div>
...
<div class="content container">
	...
	<div class="dl_zc">
		...
		<div class="d_z_content">
			<div class="order">
				<div class="o_d_title">
					<h2 class="f_l">收货人信息</h2><span class="f_r"><a class="red set-info">修改</a></span>
				</div><!--o_d_title end-->
				<div class="address">
					<ul>
						<li><span>收货人：</span>猪八戒</li>
						<li><span>地区：</span>浙江省 - 温州市 - 瑞安市</li>
						<li><span>收货地址：</span>湖岭镇湖光南路174号</li>
						<li><span>联系方式：</span>15901826010</li>
						<li><span>邮政编码：</span>325213</li>
					</ul>
				</div><!--address end-->
				<div class="ytx info-con">
				<form method="post" action="" id="">
					...
					<table>
						<tbody>
							...
							<tr>
								<td></td><td><span class="red_button"><button style="width: 140px;" type="button">保存收货人信息</button></span></td>
							</tr>
						</tbody>
					</table>
				</form>	
			...
			<form method="post" action="" id="">
				<div class="o_d_title">
					<h2 class="f_l">配送方式</h2><span class="f_r"><a class="red set-info">修改</a></span>
				</div><!--o_d_title end-->
				<div class="ytx"><p>快递-支持货到付款。</p></div>
				<div class="address info-con">
					<ul>
						<li><input type="radio" name="1" id="ps_01" checked="checked" /> <label for="ps_01">快递-支持货到付款。</label> <a href="#" class="red">查看货到付款配送地区</a></li>
						<li><input type="radio" name="1" id="ps_02" /> <label for="ps_02">EMS-不支持货到付款。</label></li>
						<li><span class="red_button"><button style="width:140px;" type="button">保存配送方式</button></span></li>
					</ul>
				</div><!--address end-->
			</form>	
			</div><!--order end-->
			...
			<form method="post" action="" id="">
				<div class="o_d_title">
					<h2 class="f_l">支付方式</h2><span class="f_r"><a class="red set-info">修改</a></span>
				</div><!--o_d_title end-->
				<div class="ytx"><p>支付宝-在线付款</p></div>
				<div class="address info-con">
					<ul>
						<li><input type="radio" name="2" id="pay_01" checked="checked" /> <label for="pay_01">支付宝-在线付款</label></li>
						<li><input type="radio" name="2" id="pay_02" /> <label for="pay_02">货到付款</label></li>
						<li><span class="red_button"><button style="width:140px;" type="button">保存支付方式</button></span></li>
					</ul>
				</div><!--address end-->
			</form>	
			</div><!--order end-->
			...
			<form method="post" action="" id="">
				<div class="o_d_title">
					<h2 class="f_l">送货时间</h2><span class="f_r"><a class="red set-info">修改</a></span>
				</div><!--o_d_title end-->
				<div class="ytx"><p>工作日、双休日与假日均可送货</p></div>
				<div class="address info-con">
					<ul>
						<li><input type="radio" name="3" id="time_01" checked="checked" /> <label for="time_01">工作日、双休日与假日均可送货</label></li>
						<li><input type="radio" name="3" id="time_02" /> <label for="time_02">只有双休日、假日送货(工作日不用送货)</label></li>
						<li><input type="radio" name="3" id="time_03" /> <label for="time_03">只有工作日送货(双休日、假日不用送)</label></li>
						<li><span class="red_button"><button style="width:140px;" type="button">保存送货时间</button></span></li>
					</ul>
				</div><!--address end-->
			</form>	
			</div><!--order end-->
			...
			<form method="post" action="" id="">
				<div class="o_d_title">
					<h2 class="f_l">发票信息</h2><span class="f_r"><a class="red set-info">修改</a></span>
				</div><!--o_d_title end-->
				<div class="ytx"><p>提供报销发票？<b class="red">是</b></p></div>
				<div class="address info-con">
					<ul>
						<li>提供报销发票？<input type="radio" name="4" id="yes" /><label for="yes">是</label>&nbsp;&nbsp;<input type="radio" name="4" id="no" /><label for="no">否</label></li>
						<li><span class="red_button"><button style="width:140px;" type="button">保存发票信息</button></span></li>
					</ul>
				</div><!--address end-->
			</form>	
			</div><!--order end-->
			...
			<form method="post" action="" id="">
				<div class="o_d_title">
					<h2 class="f_l">订单备注</h2><span class="f_r"><a class="red set-info">修改</a></span>
				</div><!--o_d_title end-->
				<div class="ytx"><p>无</p></div>
				<div class="address info-con">
					<ul>
						<li><textarea name="" id="" class="l_text" onblur="if(this.value==''){this.value='留言请在50字以内';this.className='l_text'}" onfocus="if(this.value=='留言请在50字以内'){this.value='';this.className='l_text_c'};">留言请在50字以内</textarea></li>
						<li><span class="red_button"><button style="width:140px;" type="button">保存订单备注</button></span></li>
					</ul>
				</div><!--address end-->
			</form>	
			</div><!--order end-->
			...
			$(document).ready(function(){
				$('.set-info').bind('click',function(){
					var element = $(this).parents('.order');
					if(element.hasClass('switchable')){
						element.removeClass('switchable');
						this.innerHTML="修改";
					} else {
						element.addClass('switchable');
						this.innerHTML="关闭";
					}
					return false;
				});
			...
			<form method="post" action="" id="">
				...
				<div class="cate_list_main">
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tbody>
							<tr>
								<td><a href="#"><img class="p_img" src="images/cat.jpg" style="vertical-align:middle;" /></a> <a href="#">波希米亚花边雪纺纱 紫色印花</a></td>
								<td>L</td>
								<td>258分</td>
								<td>&yen;129.00元</td>
								<td>1</td>
								...
								<td colspan="7" style="border:none;">
									<table cellpadding="0" cellspacing="0" border="0" width="100%">
										<tr>
											...
											<td>赠送积分总计：262分</td>
											<td>花费积分总计：0</td>
											<td>产品金额共计：&yen;129.00元</td>
										</tr>
										<tr>
											<td colspan="4">运费：&yen;10.0元</td>
										</tr>
										<tr>
											<td colspan="4"><span class="total red">您共需要为订单支付：&yen;139.00元</span></td>
										</tr>
									</table>
								</td>
							</tr>
				...
				<div class="tj_info">
					<div class="f_r"><input type="image" src="images/tj_dd_botton.gif" value="" /></div>
