...
<%
    ...
    List<Goods> list = service.queryByclass("男装");
%>
<head>
	...
	<div class="site-nav">
		<div class="floor_nav">
			<ul class="floors">
				...
				<li id="floor_3"><a href="man.jsp" class="selected track">男装</a></li>
...
<div class="content container">
	<div class="breadcrumbs"><a href="index.jsp">首页</a><span>></span>男装</div><!--breadcrumbs end-->
