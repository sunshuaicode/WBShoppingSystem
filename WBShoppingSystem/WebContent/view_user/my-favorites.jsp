...
<div class="content container">
	<div class="breadcrumbs">
		<a href="index.jsp">首页</a><span>></span><a href="#">我的麦路客</a><span>></span>我的收藏夹
	</div><!--breadcrumbs end-->
		...
		<div class="personal_l_m" id="personal_list">
			<dl>
				...
				<dd>
					...
					<a href="my-favorites.jsp" class="current">我的收藏夹</a>
			...
			<div class="personal_r_m_m ">
				...
				<div class="coll_m">
					<table width="100%">
						<thead>
							<tr>
								<th class="first" width="45%">商品</th><th width="15%">单价</th><th width="22%">放入时间</th><th width="18%">操作</th>
							</tr>
						</thead>
						<tbody>	
							<tr>
								<td class="first">
									<a href="#"><img src="images/3123.jpg" class="p_img" /></a>
									<a href="#" class="blue">天鹅绒活力撞色中筒袜 深紫+咖啡</a>
								</td>
								<td><span class="red">￥9.00元</span></td>
								<td><span>2010-9-20 13:46:22</span></td>
								<td><a href="#" class="blue">[购买]</a> | <a href="#" class="yellow">[删除]</a></td>
							</tr>
							<tr bgcolor="#f7f7f7">
								<td class="first">
									<a href="#"><img src="images/3123.jpg" class="p_img" /></a>
