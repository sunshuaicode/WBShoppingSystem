...
<div class="content container">
	<div class="breadcrumbs">
		<a href="index.jsp">首页</a><span>></span><a href="#">我的麦路客</a><span>></span>我的积分
	</div><!--breadcrumbs end-->
		...
		<div class="personal_l_m" id="personal_list">
			<dl>
				...
				<dd>
					...
					<a href="my-points.jsp" class="current">我的积分</a>
	...
	<div class="f_r personal_r">
		...
		<div class="personal_r_m">
			...
			<div class="personal_r_m_m ">
				<div class="blank10"></div>
				<div class="coll">
					您在麦路客商城获得的积分是： <strong class="red">0</strong> 分<a href="#" class="blue" style="margin-left:20px;">[进入折扣积分]</a>
				</div><!--coll end-->
						...
						<tbody>
							...
							<tr>
								<td class="first">
									...
									<a class="blue" href="#">天鹅绒活力撞色中筒袜 深紫+咖啡</a>
								</td>
