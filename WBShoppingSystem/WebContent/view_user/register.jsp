...
<div class="content container">
	...
	<div class="dl_zc">
		...
		<div class="dl-con" id="regist">
			<form id="formpersonal" method="post" action="../Login?method=register">
			<div class="form">
				<div class="tipinfo">注册成为会员并完善个人信息，可获得 <span class="red">10点</span>积分</div>
				<div class="item">
					<span class="label">用户id：</span>
					<div class="fl">
						<input type="text" id="userid" name="userid" class="text" tabindex="1" />
						<!--<input  type="button" id="hadent" value="检查" onclick="inspect()"/>
				...
				<div class="item">
					...
					<div class="fl">
						<input type="text" id="username" name="username" class="text"  tabindex="5" />
				...
				<div class="item">
					...
					<input type="text" name="checkcode" id="checkcodeId" size="5"/>
					<a href="javascript:reloadCheckImg($('img'))">
					<img src="imgyan.jsp" name="yan"/>
					</a>
					<a id="resultTip">点击图片换一张</a>
					<!--<div class="fl">
						 <input type="text" id="authcode" name="authcode" class="text text-1" tabindex="6" autocomplete="off" MaxLength="6" />
						<label class="img">
						<img id="JD_Verification1" VerColorOfNoisePoint="#888888" OnClick="" src="images/JDVerification.aspx.gif" alt="" style="cursor:pointer;width:100px;height:26px;" />
						</label>
