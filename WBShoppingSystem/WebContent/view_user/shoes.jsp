...
<%
    ...
    List<Goods> list = service.queryByclass("鞋");
%>
	...
	<div class="site-nav">
		<div class="floor_nav">
			<ul class="floors">
				...
				<li id="floor_4"><a href="shoes.jsp" class="selected track">鞋子</a></li>
...
<div class="content container">
	<div class="breadcrumbs"><a href="index.jsp">首页</a><span>></span>鞋子</div><!--breadcrumbs end-->
	<div class="area_l con_l">
		<div class="product-sort">
			<h2>商品分类</h2>
			<div class="sort-con">
				<div class="sort-list">
					<h3><span class="f_l icon04"></span><a href="shoes.jsp" class="f_l">鞋子</a></h3>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="#" class="f_l">男鞋</a></dt>
						<dd>
							<a class="current" href="#"><span>·</span>凉鞋 (<b class="yellow">9</b>)</a>
							<a href="#"><span>·</span>单鞋 (<b class="yellow">7</b>)</a>
							<a href="#"><span>·</span>家居鞋 (<b class="yellow">6</b>)</a>
							<a href="#"><span>·</span>休闲鞋 (<b class="yellow">4</b>)</a>
							<a href="#"><span>·</span>运动鞋 (<b class="yellow">17</b>)</a>
						</dd>
					</dl>
					<dl>
						<dt class="current"><span class="f_l arrow"></span><a href="#" class="f_l">女鞋</a></dt>
						<dd>
							<a href="#"><span>·</span>凉鞋 (<b class="yellow">9</b>)</a>
							<a href="#"><span>·</span>单鞋 (<b class="yellow">3</b>)</a>
							<a href="#"><span>·</span>高跟鞋 (<b class="yellow">16</b>)</a>
							<a href="#"><span>·</span>靴子 (<b class="yellow">10</b>)</a>
							<a href="#"><span>·</span>家居鞋 (<b class="yellow">3</b>)</a>
							<a href="#"><span>·</span>休闲鞋 (<b class="yellow">6</b>)</a>
							<a href="#"><span>·</span>运动鞋 (<b class="yellow">7</b>)</a>
						</dd>
					</dl>
				</div>
	...
	<div class="area_r con_r">
		...
		<div class="category">
			...
			<div class="total"><p class="f_r yellow">共<b class="red"><%=list.size() %></b>个商品</p></div><!--total end-->
